...
export class Router {
    ...
    setupNavigation() {
        ...
        nav.innerHTML = `
            ...
            <a href="#/session" class="nav-link" data-route="/session">Session</a>
            <a href="#/notes" class="nav-link" data-route="/notes">Notes</a>
            <a href="#/npcs" class="nav-link" data-route="/npcs">NPCs</a>
